...
2. FLiberator unzips the file, also into `download/` — extracting only the 13 `.nxt` data files, not the 1,369 other entries of the Windows viewer application Florida wraps them in.
